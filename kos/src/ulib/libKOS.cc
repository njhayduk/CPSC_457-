...
/* create method stub */
extern "C" int isEven (int n)
{
	// sycalNum::methodname,parameter)
	return syscallStub(SyscallNum::isEven,n);

}


/* create method stub for assign 1 */
extern "C" long sysadd (long n1, long n2)
{
	return syscallStub(SyscallNum::sysadd,n1,n2);
